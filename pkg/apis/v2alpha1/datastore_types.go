...
// +kubebuilder:resource:shortName=dst;dstore
...
const (
	DataStorePhaseCreating DataStorePhase = "Creating"
	DataStorePhaseRunning  DataStorePhase = "Running"
	DataStorePhaseFailed   DataStorePhase = "Failed"
	DataStorePhaseDeleting DataStorePhase = "Deleting"
)

type DataStoreStatus struct {
	// Phase of the database cluster.
	Phase DataStorePhase `json:"phase,omitempty"`
