...
// 2. Validation Webhook (/validate) - Accepts admission review requests and validates DataStores
...
// ValidatorFunc is a function that validates a DataStore.
// It receives the context, a Kubernetes client (for fetching related resources),
// and the DataStore to validate.
// Return nil if validation passes, or an error with a user-friendly message.
type ValidatorFunc func(ctx context.Context, c client.Client, dc *v2alpha1.DataStore) error
...
type ValidationRequest struct {
	// Object is the DataStore being validated
	Object v2alpha1.DataStore `json:"object"`

	// OldObject is the existing DataStore (for UPDATE operations)
	// May be nil for CREATE operations
	OldObject *v2alpha1.DataStore `json:"oldObject,omitempty"`
